...
from cafe_manager.common.exceptions import CafeEnvError, CafeInitError
...
class CafeRemoveHandler:
    def __init__(self, env_folder_path: Path, env_manager: EnvironmentManager, data_folder: Path) -> None:
        self.base_path = env_folder_path
        self._env_manager = env_manager
    ...
    def handle(self, name: str) -> None:
        ...
        try:
            ...
            raise CafeEnvError("Impossible to remove unexistent cafe") from e
...
class CafeInitHandler:
    def __init__(self, db_path: Path, cafe_repo: CafeRepo, account: FinanceRepo) -> None:
